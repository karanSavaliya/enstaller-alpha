...
//icon size
  ...
  static String formattedDate2(date) => DateFormat('dd/MM/yyyy HH:mm aa').format(date);
  ...
  static double getExpandedAgentListHeight(bool emprtyTable, int langth) {
    print(emprtyTable);
    print('$langth');
    double extraHeight = SizeConfig.screenHeight * .05;
    if (langth > 0) {
      return (SizeConfig.screenHeight * .05 * langth) + extraHeight;
    } else {
      return SizeConfig.screenHeight * .05;
    }
  }
