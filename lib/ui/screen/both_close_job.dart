...
class BothCloseJob extends StatefulWidget {
  ...
  BothCloseJob(
      {@required this.list, @required this.dsmodel, @required this.status});
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text("Close Jobs", style: TextStyle(color: Colors.white)),
        ),
        body: _showIndicator
            ...
            : Column(
                children: [
                  ...
                  AppButton(
                    onTap: () async {
                      if (GlobalVar.elecCloseJob >= 1 &&
                          GlobalVar.gasCloseJob >= 1) {
                        setState(() {
                          _showIndicator = true;
                        });
                        AppConstants.showSuccessToast(
                            context, "Job Saved Successfully");
