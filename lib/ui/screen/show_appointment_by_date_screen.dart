...
class ShowAppointmentByDateScreen extends StatefulWidget {
  ...
  @override
  _ShowAppointmentByDateScreenState createState() =>
      _ShowAppointmentByDateScreenState();
}

class _ShowAppointmentByDateScreenState
    extends State<ShowAppointmentByDateScreen> {
            ...
            appBar: AppBar(
              ...
              title: model.searchBool
                  ...
                  : Text(
                      ...
                      style: getTextStyle(
                          color: Colors.orangeAccent, isBold: true),
                    ),
              actions: [
                InkWell(
                  child: Padding(
            ...
            children: [
              Expanded(
                  ...
                  child: Text(
                    ...
                    style: getTextStyle(
                        color: AppColors.darkGrayColor, isBold: true),
                  )),
              Expanded(
                  flex: 1,
                  child: Text(
