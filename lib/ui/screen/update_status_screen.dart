      ...
      builder: (context, model, child) {
        return Scaffold(
          ...
          appBar: AppBar(
            ...
            actions: [
              IconButton(
                  icon: Icon(model.search ? Icons.clear : Icons.search,
                      color: AppColors.whiteColor),
                  onPressed: () {
                    model.onSearch();
                  }),
                                ...
                                children: [
                                  Expanded(
                                    child: DropdownButton<String>(
                                      ...
                                      items:
                                          model.statusList.map((String value) {
              ...
              : Padding(
                  ...
                  child: Container(
                    decoration: BoxDecoration(boxShadow: [
                      BoxShadow(
                          color: AppColors.lightGrayDotColor, blurRadius: 10)
                    ]),
                    child: ListView.builder(
                        itemCount: model.appointmentStatusList.length,
                        itemBuilder: (context, int index) {
                          return CustomExpandedTile(
                            expanded:
                                model.appointmentStatusList[index].intId ==
                                    model.expandSelectedStatus.intId,
                            firstChild: Container(
                              ...
                              child: Row(
                                children: [
                                  model.appointmentStatusList[index]
                                      ...
                                      ? Opacity(
                                          opacity: 0,
                                          child: Checkbox(
                                              value: model.selectedAppointments
                                                  .contains(model
                                      ...
                                      : Checkbox(
                                          value: model.selectedAppointments
                                              .contains(
                                                  model.appointmentStatusList[
                                                      index]),
                                          onChanged: (val) {
                                            model.onSelectAppointment(model
                                          ...
                                          children: [
                                            ...
                                            Padding(
                                              ...
                                              child: Text(
                                                ...
                                                style: TextStyle(
                                                    color: AppColors.statusColor(model
                                                        .appointmentStatusList[
                                                            index]
                                                        .appointmentEventType)),
                                              ),
                                            ...
                                            child: Row(
                                              children: [
                                                SizedBox(
                                                  ...
                                                  width: 20,
                                                  child: SvgPicture.asset(
                                                      AppConstants.getStatusImageUrl(model
                                                          .appointmentStatusList[
                                                              index]
                                                          ?.appointmentEventType),
                                                      semanticsLabel: 'Status'),
